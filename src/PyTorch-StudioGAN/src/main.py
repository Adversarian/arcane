...
def load_configs_initialize_training():
    ...
    parser.add_argument('--eval_backbone', type=str, default='InceptionV3_tf',\
                        help="[InceptionV3_tf, InceptionV3_torch, ResNet50_torch, SwAV_torch, DINO_torch, Swin-T_torch, MNIST_ResNet18_torch]")
    ...
    parser.add_argument("-c", "--compile", action="store_true", help="whether to compile the model using torch.compile()")
    ...
    cfgs.OPTIMIZATION.compile = args.compile
